...
INSERT INTO `controllers_list` (`id`,`name`) VALUES (11,'AdminController');
...
INSERT INTO `session` (`id`,`lastaction`,`ip`) VALUES ('1lnu391n6vp91en911beq29kv0',1202421740,'');
INSERT INTO `session` (`id`,`lastaction`,`ip`) VALUES ('8pmnelr7c12gpktdnpnm1lln92',1202652601,'');
INSERT INTO `session` (`id`,`lastaction`,`ip`) VALUES ('ciomqul4d5f8rjgrhacq2hrtd0',1202688961,'');
INSERT INTO `session` (`id`,`lastaction`,`ip`) VALUES ('dlokcf32s4u3a9tmaqjbi2tvq6',1202427836,'');
INSERT INTO `session` (`id`,`lastaction`,`ip`) VALUES ('nlsqs4bn910arcpsnehl7d1vd0',1202190240,'');
INSERT INTO `session` (`id`,`lastaction`,`ip`) VALUES ('rji8u4l207gt09n8uu7ufdrke4',1202314595,'');
...
) ENGINE=MyISAM AUTO_INCREMENT=836 DEFAULT CHARSET=cp1251;
