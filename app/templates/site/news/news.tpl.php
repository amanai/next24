...
<div class="columns-page clearfix">
					<div class="main"><div class="wrap">
						<ul class="view-filter clearfix">
							<li><strong>Все новости<span></span></strong></li>
							<li><a href="#">Только подписанные</a></li>
							<li><a href="#">Избранные (254)</a></li>
						</ul>
						<!-- /view-filter -->
						...
						<?php $aNewsTree = $this -> getAllNewsTree(); 					
						...
						<div class="navigation">
							...
							<ul class="nav-list">
								...
								<li class="active"><i class="arrow-icon"></i><a href="#">Internet</a>
									<ul>
										<li><input type="checkbox" /><a href="#">AUDI</a> (8)</li>
										<li><input type="checkbox" checked="checked" /><a href="#">Acura</a> (3)</li>
										<li><input type="checkbox" /><a href="#">BMW</a> (25)</li>
										<li><input type="checkbox" /><a href="#">Chrysler</a> (14)</li>
										<li><input type="checkbox" /><a href="#">Citroen</a> (28)</li>
										<li><input type="checkbox" /><a href="#">Acura</a> (3)</li>
										<li><input type="checkbox" checked="checked" /><a href="#">BMW</a> (25)</li>
										<li><input type="checkbox" checked="checked" /><a href="#">Chrysler</a> (14)</li>
										<li><input type="checkbox" /><a href="#">Citroen</a> (28)</li>
										<li><input type="checkbox" /><a href="#">Acura</a> (3)</li>
										<li><input type="checkbox" /><a href="#">BMW</a> (25)</li>
										<li><input type="checkbox" checked="checked" /><a href="#">Chrysler</a> (14)</li>
