       ...
       <div style="margin: 0px -10px;">
        <table class="questions">
         ...
         <tr id="cmod_tab2">
          ...
          <td><a href="<?=$this->bookmark_row['url'];?>" title="<?=$this->bookmark_row['url'];?>"><?=$this->bookmark_row['url_cut'];?></a></td>
...
<!-- /Вывод строки закладки -->
				...
				<div class="block_ee1">
					<div class="block_ee2">
						<div class="block_ee3">
							<div class="block_ee4">
								<div class="block_title"><h2><a href="#"><?=$this->bookmark_row['login']?></a></h2></div>
