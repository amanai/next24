					...
					<div class="main"><div class="wrap"> 
						<form class="main-form" action="#" method="post"> 
							<fieldset class="alt"> 
								...
								<p class="field-help main-field-help"><span>Логин <strong>BosonogiyGen</strong></span> Чтобы изменить логин - обратитесь в <a href="#">службу поддержки</a></p> 
								<ul class="clearfix"> 
									<li class="field-it"> 
										<div class="label"><label for="f1">Email <em>*</em></label></div> 
										<div class="field f-mid"> 
											<input type="text" id="f1" value="madcros@gmail.com" /> 
										</div> 
									</li> 
									<li class="field-it fl-l"> 
										<div class="label"><label for="f2">Новый пароль <em>*</em></label></div> 
										<div class="field f-mid"> 
											<input type="password" id="f2" value="" /> 
										</div> 
									</li> 
									<li class="field-it"> 
										<div class="label"><label for="f3">Подтверждение пароля <em>*</em></label></div> 
										<div class="field f-mid"> 
											<input type="password" id="f3" value="" /> 
										</div> 
									</li> 
