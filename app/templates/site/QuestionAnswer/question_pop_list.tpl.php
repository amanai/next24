					...
					<div class="main"><div class="wrap"> 
						...
						<div class="display-filter clearfix"> 
							<div class="number-filter"> 
								показывать по: 
							<?php if(!$qpp || $qpp == 10){ ?>
									<strong>10</strong> | <a href="<?php echo $this->createUrl('QuestionAnswer', 'ListPop', null, false); ?>/qpp:20">20</a> | <a href="<?php echo $this->createUrl('QuestionAnswer', 'ListPop', null, false); ?>/qpp:30">30</a> ответов
							<?php }elseif($qpp == 20) { ?>
									<a href="<?php echo $this->createUrl('QuestionAnswer', 'ListPop', null, false); ?>/qpp:10">10</a> | <strong>20</strong> | <a href="<?php echo $this->createUrl('QuestionAnswer', 'ListPop', null, false); ?>/qpp:30">30</a> ответов
							<?php } elseif($qpp == 30) { ?>	
									<a href="<?php echo $this->createUrl('QuestionAnswer', 'ListPop', null, false); ?>/qpp:10">10</a> | <a href="<?php echo $this->createUrl('QuestionAnswer', 'ListPop', null, false); ?>/qpp:20">20</a> | <strong>30</strong> ответов
							<? } ?>								
							</div> 
						</div> 
						<!-- /display-filter --> 
