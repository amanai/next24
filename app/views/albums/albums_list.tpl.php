													...
													<div class="block_ee3">
														<div class="block_ee4">
															<div class="block_title">
																<h2><a href="<?php echo $this->router->createUrl('Photo', 'Album', array('id'=>$item['id']));?>"><?php echo $item['name'];?></a></h2>
															</div>
															...
															<div class="block_title2">
																<a href="<?php echo  $this->router->createUrl('User', 'Profile', array('id'=>$item['user_id']));?>"><?php echo $item['login'];?></a><br />
