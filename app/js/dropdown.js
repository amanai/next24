...
//		alert(id);
//		alert($(this).parent().parent().parent().parent().css('display'));
//		if($(this).parent().parent().parent().parent().css('display')=='block') {
			$.fn.HideEasyWidget(id);
//		}
//		else {
//			$.fn.ShowEasyWidget(id, WidgetOptions);
//		}
	//	$.fn.HideEasyWidget('identifierwidget-1', WidgetOptions);
	//	$.fn.ShowEasyWidget('identifierwidget-1', WidgetOptions);
