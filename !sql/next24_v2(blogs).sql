...
INSERT INTO `albums` (`id`,`user_id`,`thumbnail_id`,`name`,`access`,`is_onmain`,`creation_date`) VALUES (1,1,10,'Осень',1,1,'2008-01-14 21:00:00');
...
INSERT INTO `albums` (`id`,`user_id`,`thumbnail_id`,`name`,`access`,`is_onmain`,`creation_date`) VALUES (8,1,17,'Лето',0,0,'2008-01-23 03:21:28');
...
INSERT INTO `photos` (`id`,`user_id`,`album_id`,`name`,`path`,`thumbnail`,`is_rating`,`is_onmain`,`access`,`voices`,`rating`,`creation_date`) VALUES (1,1,1,'осень','asd','as',1,1,1,1,2,'2008-01-21 14:20:12');
...
INSERT INTO `photos` (`id`,`user_id`,`album_id`,`name`,`path`,`thumbnail`,`is_rating`,`is_onmain`,`access`,`voices`,`rating`,`creation_date`) VALUES (5,1,5,'весна','sdfer5y5','34t34',1,1,1,4,14,'2008-01-22 04:20:12');
...
INSERT INTO `photos` (`id`,`user_id`,`album_id`,`name`,`path`,`thumbnail`,`is_rating`,`is_onmain`,`access`,`voices`,`rating`,`creation_date`) VALUES (18,1,7,'М157','f1bf3e85dd373ecc2fe015ab9349b2e3.jpg','f1bf3e85dd373ecc2fe015ab9349b2e3.jpg',0,0,1,0,0,'2008-01-23 03:31:37');
...
INSERT INTO `users` (`id`,`first_name`,`middle_name`,`last_name`,`email`,`login`,`pass`,`birth_date`,`gender`,`about`,`interest`,`reg_date`,`su_vis_date`,`group_id`,`country_id`,`city`,`hash`,`status`,`tabs_map`,`reputation`,`nextmoney`,`user_type_id`,`banned`,`registration_date`) VALUES (1,'Админ','','Админов','','admin','admin',NULL,0,'','',0,0,0,0,'','',0,'1111111',0,0,1,0,NULL);
INSERT INTO `users` (`id`,`first_name`,`middle_name`,`last_name`,`email`,`login`,`pass`,`birth_date`,`gender`,`about`,`interest`,`reg_date`,`su_vis_date`,`group_id`,`country_id`,`city`,`hash`,`status`,`tabs_map`,`reputation`,`nextmoney`,`user_type_id`,`banned`,`registration_date`) VALUES (2,'Тест','Пользователь','Фамилия','a@email.com','user','user',NULL,1,'asd','qd',12121212,123123,1,1,'город','sdfdsfsd',1,'1111111',0,0,1,0,NULL);
