...
<div class="block_ee1"><div class="block_ee2"><div class="block_ee3"><div class="block_ee4">
    ...
    <p><a href="javascript: void(0);" onclick="ShowMessages(0, 0, '. Общая');"><img height="12" width="15" id="ico2" src="<?php echo $this -> image_url;?>/folder.png"/>Общая <span id="total_mes0">(<?php echo '<font class="red">'.$this->aGroupMessagesCount[0]['new'].'</font>/'.$this->aGroupMessagesCount[0]['read']; ?>)</span></a></p>
    <?php
