<div class="block_ee1">
	...
	<?php if ($this->allow_add_comment) { ?>
		<form action="<?php echo $this->router->createUrl($this->add_comment_controller, $this->add_comment_action);?>" method="post">
			<?php if($this->add_comment_page_number > 0) { ?>
				<input type="hidden" name="pn" value="<?php echo $this->add_comment_page_number;?>" />
			<?php } ?>
			<input type="hidden" name="id" value="<?php echo $this->add_comment_item_id;?>" />
