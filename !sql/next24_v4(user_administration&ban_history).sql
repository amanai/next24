...
INSERT INTO `session` (`id`,`lastaction`,`ip`) VALUES ('5gc84b86uilcum380htu0i4tb6',1202999879,'');
...
INSERT INTO `session_vars` (`id`,`name`,`session`,`value`) VALUES (884,'LAST_PATH','5gc84b86uilcum380htu0i4tb6','/next24/AdminUser/Save//id:1/form_id:edit_user_form');
