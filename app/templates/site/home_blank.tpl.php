				...
				<div class="widget-page clearfix"> 
					...
					<div class="widget-columns clearfix"> 
						...
						<div class="column widget-place"> 
							<div class="widget movable" id="news" style="display:none;"> 
						...
						<!-- /column --> 
						<div class="column widget-place"> 
							<div class="widget movable" id="photo" style="display:none;"> 
								<div class="widget-header clearfix" style="cursor:move;"> 
							...
							<!-- /widget --> 
							<div class="widget movable" id="question" style="display:none;"> 
								<div class="widget-header clearfix" style="cursor:move;"> 
						...
						<div class="column alt-column widget-place"> 
							<div class="widget movable" id="articles" style="display:none;"> 
								<div class="widget-header clearfix" style="cursor:move;"> 
