										...
										<div>
											...
											<div style="text-align: left;">
												...
												<?php if ($item['owner'] === true) { ?>
													<span><a href="<?php echo $this->createUrl('Societies', 'PostEdit', array($item['id']));?>">редактировать</a></span>&nbsp;&nbsp;
													<span><a href="<?php echo $this->createUrl('Societies', 'PostDelete', array($item['id']));?>" class="redlink">удалить</a></span>
												<? } ?>
											</div>
										</div>
										<br>
